...
First, go to the [nf-core/mcmicro releases page](https://github.com/nf-core/mcmicro/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
